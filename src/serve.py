...
def download_model():
    ...
    Ham nay duoc goi mot lan khi module duoc import. AWS credentials duoc
    doc tu bien moi truong hoac IAM role cua EC2 instance.
    """
    ...
    try:
        ...
        raise RuntimeError(f"Could not download s3://{S3_BUCKET}/{S3_MODEL_KEY}") from exc
